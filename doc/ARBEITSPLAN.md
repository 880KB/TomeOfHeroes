...
4. **Prüfen, ob `feats.yml` aus einer D&D-3.0- statt 3.5-Quelle stammt** — beim Waffenkatalog (3a) stellte sich heraus, dass "Kapitel 7 - Ausrüstung (Seiten 117-140).pdf" strukturell die 3.0er-Waffentabelle ist, nicht 3.5 (siehe "Erledigt" oben). "Kapitel 5 - Talente (Seiten 95-106).pdf", die Quelle aller 74 Talente, stammt dem Namensmuster nach vermutlich aus demselben Buch. Klären (z. B. Impressum/Titelseite des physischen Buchs, oder Stichprobe: eine bekannt 3.5-spezifische Talent-Regel wie die genauen Bonusfeat-Listen gegenprüfen) — falls tatsächlich 3.0, betrifft das potenziell alle 74 Talente und ist wichtiger als jede einzelne Detailfrage unten.
